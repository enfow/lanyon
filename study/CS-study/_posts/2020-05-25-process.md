...
<img src="{{site.image_url}}/study/compile_linking_loading.png" style="width:35em">
...
compile이 되었다고 해서 곧바로 실행할 수 있는 것은 아닌데, 왜냐하면 해당 코드를 동작시키기 위해서는 해당 코드 외에도 다른 파일 또는 라이브러리가 필요한 경우가 많기 때문이다(C의 `#include <stdio.h>`가 대표적이다). 이를 위해 다른 파일 및 라이브러리와 연결하는 작업이 `Linking` 이다.
...
<img src="{{site.image_url}}/study/memory_layout.png" style="width:35em">
...
<img src="{{site.image_url}}/study/process_state.png" style="width:35em">
...
<img src="{{site.image_url}}/study/context_switch.png" style="width:35em">
...
<img src="{{site.image_url}}/study/unix_process_hierarchy.png" style="width:35em">
